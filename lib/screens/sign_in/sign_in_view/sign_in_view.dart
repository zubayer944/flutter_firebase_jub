              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              ...
                              width:
                                  0.5.w), // Set the border color and width here
                        ),
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(14.0.sp),
                          borderSide: BorderSide(
                              color: const EoColors().eoTextBoxBorderColor,
                              width: 0.5.w), // Border color when focused
                        ),
                        errorBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              color: Colors.red,
                              width:
                                  0.5.w), // Border color when there's an error
                        ),
                        focusedErrorBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              color: Colors.red,
                              width: 0.5
                                  .w), // Border color when focused with error
                        ),
                        prefixIcon: Icon(
                    ...
                    TextFormField(
                      controller:
                          sIgnInController.passwordTextEditingController,
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedErrorBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: Colors.red,
                            // Border color when focused with error
                            width: 0.5.w,
                          ),
                        ),
                        prefixIcon: Icon(
                          Icons.lock_outline, // Icon to show in the prefix
                          color: const EoColors()
                              .eoTextBoxBorderColor, // Icon color
                        ),
                      ),
